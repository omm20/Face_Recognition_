...
#first image
        img = Image.open(r"photos/GNDU_logo1.png")
...
#third image
        ...
        f_lbl.place(x=1015,y=0,width = 510, height=130)
#background image 
        img3 = Image.open(r"photos/istockphoto-1470072058-612x612.jpg")
...
#Studebt Details button
        img4 = Image.open(r"photos/student_details.jpg")
...
#Detect face button
        img5 = Image.open(r"photos/face_detector1.jpg")
...
#Student Attendance button
        img6 = Image.open(r"photos/attendance1.jpg")
        ...
        b1_1=Button(bg_img,text="Attendence",cursor="hand2",command=self.attendance_data,font=("times new roman",15,"bold"),bg="white",fg="black")
        b1_1.place(x=800,y=300,width=220,height=40)
        

#help desk button
        img7 = Image.open(r"photos/help_desk1.jpg")
        ...
        b1_1=Button(bg_img,text="help dekh",cursor="hand2",command=self.help_data,font=("times new roman",15,"bold"),bg="white",fg="black")
        b1_1.place(x=1100,y=300,width=220,height=40)
        

#train data button
        img8 = Image.open(r"photos/train_model1.jpg")
        ...
        b1_1=Button(bg_img,text="Train Model",cursor="hand2",command=self.train_data,font=("times new roman",15,"bold"),bg="white",fg="black")
        b1_1.place(x=200,y=580,width=220,height=40)
        
        

#photos data button
        img9 = Image.open(r"photos/facedetect_img.png")
...
#developer button
        img10 = Image.open(r"photos/developer1.jpg")
